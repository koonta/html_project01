...
//    });
    ...
    var kk = $(".tgwrap>.tgswrap>.f2gnb_ul>li");
    var kkk = kk.index();
   
    
//    $(".tgwrap>.tgswrap>.f2gnb_ul>li:nth-child(2").click(function(){
//        $(".tgwrap>.tgswrap>.f2gnb_ul>li:nth-child(2)>a>span").toggleClass("in");
//        $(".tgswrap>.f2gnb_ul>li>.ssgb01").toggleClass("ccc");
//        
//    });
//    $(".tgwrap>.tgswrap>.f2gnb_ul>li:nth-child(2").click(function(){
//        $(".tgwrap>.tgswrap>.f2gnb_ul>li:nth-child(2)>a>span").toggleClass("in");
...
//    });
//    
//    $(".tgwrap>.tgswrap>.f2gnb_ul>li:nth-child(3").click(function(){
//        $(".tgwrap>.tgswrap>.f2gnb_ul>li:nth-child(3)>a>span").toggleClass("in");
//        $(".tgswrap>.f2gnb_ul>li>.ssgb02").toggleClass("ccc");
//        
//        
//    });
	 ...
	 $(".main").click(function(){
		 if(!$(this).hasClass("active")){
				...
				$(".main").each(function(){
				    ...
				    $(this).find(".ssgb01").slideUp();	
						
					}
				});
			 
			  $(this).addClass("active");
			  $(this).find(".ssgb01").slideDown();
				}else{
    ...
    $(".slcir li").click(function(){
        var ne = $(this).index();
        $(".slcir li").removeClass();
        $(".slcir li").eq(ne).addClass("click");
        if(ne == 0){
            $(".bslider").css("left","0px");
        }else{
            $(".bslider").css("left","-610px");
        }
    });
     ...
     $(window).scroll(function(e){
         ...
         if($(this).scrollTop() > 250){
             $(".tm").fadeIn();
             $(".tm").stop().animate({top:top+"px"}, 500);
         }
         else{
            $(".tm").fadeOut();
              }
    ...
    $(".se01>ul>li").click(function(){
        var Li = $(this).index();
        console.log(Li);
        $(".se01 ul li").removeClass();
        $(".se01 ul li").eq(Li).addClass("go");
    });
    
    $(".se02>ul>li").click(function(){
        var Li = $(this).index();
        console.log("aaa:"+Li);
        $(".se02 ul li").removeClass();
        $(".se02 ul li").eq(Li).addClass("go");
    });
    
    $(".se03>ul>li").click(function(){
        var Li = $(this).index();
//        $(".se03 ul li").removeClass();
        $(".se03 ul li").eq(Li).toggleClass("go");
        $(".se03>ul>li>.smdiv").toggle();
//        $(".se03>ul>li>div").removeClass();
        $(".se03>ul>li>mdopen").toggleClass("mdopen2");
    });
...
//         e.preventDefault();
         ...
         if($(this).scrollTop() > 550){
             $(".m3box>.m301").css("opacity","1");
             $(".m3box>.m301").stop().animate({top:"0px"}, 500);
             $(".m3box>.m302").css("opacity","1");
             $(".m3box>.m302").stop().animate({top:"0px"}, 600);
             $(".m3box>.m303").css("opacity","1");
             $(".m3box>.m303").stop().animate({top:"0px"}, 700);
         }
        if($(this).scrollTop() > 1150){
             $(".m4cb>.m401").css("opacity","1");
             $(".m4cb>.m401").stop().animate({top:"0px"}, 700);
             $(".m4cb>.m402").css("opacity","1");
             $(".m4cb>.m402").stop().animate({top:"0px"}, 800);
             $(".m4cb>.m403").css("opacity","1");
             $(".m4cb>.m403").stop().animate({top:"-350px"}, 900);
             $(".m4cb>.m404").css("opacity","1");
             $(".m4cb>.m404").stop().animate({top:"-350px"}, 1000);
         }
    });
